...
type TopicService interface {
	...
	GetTopicByID(c context.Context, id string) (*Topic, error)
...
func (s *topicService) GetTopicByID(c context.Context, id string) (*Topic, error) {
	...
	return s.topicRepository.GetTopicByID(c, objectID)
}
